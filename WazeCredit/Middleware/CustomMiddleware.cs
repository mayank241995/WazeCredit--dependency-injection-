...
namespace WazeCredit.Middleware
{
    public class CustomMiddleware
    {
       ...
       public async Task InvokeAsync(HttpContext context,TransientService transientService,ScopedService SingletonService
           ,SingletonService singletonService)
        {
            context.Items.Add("CustomMiddlewareTransient", "Transient Middleware" +transientService.GetGuid());
            context.Items.Add("CustomMiddlewareScoped", "Scoped Middleware" +SingletonService.GetGuid());
